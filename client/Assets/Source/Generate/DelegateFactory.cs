...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(System.Action<UnityEngine.WWW,string,string>), factory.System_Action_UnityEngine_WWW_string_string);
		...
		dict.Add(typeof(NetEventCallback), factory.NetEventCallback);
		dict.Add(typeof(NetMsgCallback), factory.NetMsgCallback);
		...
		DelegateTraits<System.Action<UnityEngine.WWW,string,string>>.Init(factory.System_Action_UnityEngine_WWW_string_string);
		...
		DelegateTraits<NetEventCallback>.Init(factory.NetEventCallback);
		DelegateTraits<NetMsgCallback>.Init(factory.NetMsgCallback);
		...
		TypeTraits<System.Action<UnityEngine.WWW,string,string>>.Init(factory.Check_System_Action_UnityEngine_WWW_string_string);
		...
		TypeTraits<NetEventCallback>.Init(factory.Check_NetEventCallback);
		TypeTraits<NetMsgCallback>.Init(factory.Check_NetMsgCallback);
		...
		StackTraits<System.Action<UnityEngine.WWW,string,string>>.Push = factory.Push_System_Action_UnityEngine_WWW_string_string;
		...
		StackTraits<NetEventCallback>.Push = factory.Push_NetEventCallback;
		StackTraits<NetMsgCallback>.Push = factory.Push_NetMsgCallback;
	...
	class System_Action_UnityEngine_WWW_string_string_Event : LuaDelegate
	{
		public System_Action_UnityEngine_WWW_string_string_Event(LuaFunction func) : base(func) { }
		public System_Action_UnityEngine_WWW_string_string_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(UnityEngine.WWW param0, string param1, string param2)
		{
			func.BeginPCall();
		...
		public void CallWithSelf(UnityEngine.WWW param0, string param1, string param2)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public System.Action<UnityEngine.WWW,string,string> System_Action_UnityEngine_WWW_string_string(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			System.Action<UnityEngine.WWW,string,string> fn = delegate(UnityEngine.WWW param0, string param1, string param2) { };
			return fn;
		}

		if(!flag)
		{
			System_Action_UnityEngine_WWW_string_string_Event target = new System_Action_UnityEngine_WWW_string_string_Event(func);
			System.Action<UnityEngine.WWW,string,string> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			System_Action_UnityEngine_WWW_string_string_Event target = new System_Action_UnityEngine_WWW_string_string_Event(func, self);
			System.Action<UnityEngine.WWW,string,string> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_System_Action_UnityEngine_WWW_string_string(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(System.Action<UnityEngine.WWW,string,string>), L, pos);
	}

	void Push_System_Action_UnityEngine_WWW_string_string(IntPtr L, System.Action<UnityEngine.WWW,string,string> o)
	{
		ToLua.Push(L, o);
	}
	...
	class NetEventCallback_Event : LuaDelegate
	{
		public NetEventCallback_Event(LuaFunction func) : base(func) { }
		public NetEventCallback_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(NetSocket param0, int param1)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.Push(param1);
		...
		public void CallWithSelf(NetSocket param0, int param1)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public NetEventCallback NetEventCallback(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			NetEventCallback fn = delegate(NetSocket param0, int param1) { };
			return fn;
		}

		if(!flag)
		{
			NetEventCallback_Event target = new NetEventCallback_Event(func);
			NetEventCallback d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			NetEventCallback_Event target = new NetEventCallback_Event(func, self);
			NetEventCallback d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_NetEventCallback(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(NetEventCallback), L, pos);
	}

	void Push_NetEventCallback(IntPtr L, NetEventCallback o)
	{
		ToLua.Push(L, o);
	}

	class NetMsgCallback_Event : LuaDelegate
	{
		public NetMsgCallback_Event(LuaFunction func) : base(func) { }
		public NetMsgCallback_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(ByteStream param0)
		{
			func.BeginPCall();
			func.PushObject(param0);
			func.PCall();
		...
		public void CallWithSelf(ByteStream param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public NetMsgCallback NetMsgCallback(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			NetMsgCallback fn = delegate(ByteStream param0) { };
			return fn;
		}

		if(!flag)
		{
			NetMsgCallback_Event target = new NetMsgCallback_Event(func);
			NetMsgCallback d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			NetMsgCallback_Event target = new NetMsgCallback_Event(func, self);
			NetMsgCallback d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_NetMsgCallback(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(NetMsgCallback), L, pos);
	}

	void Push_NetMsgCallback(IntPtr L, NetMsgCallback o)
	{
		ToLua.Push(L, o);
	}
