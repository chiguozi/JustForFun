...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		WWWLoaderWrap.Register(L);
		LuaHelperWrap.Register(L);
		NetSocketWrap.Register(L);
		ByteStreamWrap.Register(L);
		L.RegFunction("NetEventCallback", NetEventCallback);
		L.RegFunction("NetMsgCallback", NetMsgCallback);
		L.BeginModule("DG");
		...
		L.RegFunction("Action_UnityEngine_WWW_string_string", System_Action_UnityEngine_WWW_string_string);
		L.EndModule();
		L.EndModule();
		L.BeginPreLoad();
	...
	static int NetEventCallback(IntPtr L)
	{
		try
		{
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<NetEventCallback>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<NetEventCallback>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int NetMsgCallback(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<NetMsgCallback>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<NetMsgCallback>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int System_Action_UnityEngine_WWW_string_string(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<System.Action<UnityEngine.WWW,string,string>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<System.Action<UnityEngine.WWW,string,string>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
